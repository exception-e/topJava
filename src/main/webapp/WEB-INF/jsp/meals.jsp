...
<section>
    ...
    <hr/>
    <a href="meals?action=create"><spring:message code="meal.add_meal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals?action=update&id=${meal.id}">common.update</a></td>
                <td><a href="meals?action=delete&id=${meal.id}">common.delete</a></td>
            </tr>
        </c:forEach>
    </table>
</section>
