...
### Все материалы проекта (в том числе и будущие обновления) останутся доступны без ограничения по времени в [Google Drive](https://drive.google.com/drive/u/0/folders/0B9Ye2auQ_NsFflp6ZHBLSFI2OGVEZ2NQU0pzZkx4SnFmOWlzX0lzcDFjSi1SRk5OdzBYYkU)
...
### **[Выполнить выпускной проект](https://github.com/JavaWebinar/topjava/blob/doc/doc/graduation.md)**
   ...
   -  **Возможно [доплатить за ревью выпускного отдельно из JavaOPs профиля](https://javaops.ru/auth/payonline?payId=OG), как за тестовое собеседование: 3950р**
...
### **Получить первое открытое занятие МНОГОПОТОЧНОСТЬ и пройти эту важную тему в [проекте Masterjava](http://javaops.ru/view/masterjava)**
   ...
   - **До 15.01 на курс MasterJava для выпускников специальная цена.**  
...
### **Моя реализация выпускного проекта [TopJava-2](http://javaops.ru/view/topjava2)**
   ...
   - **До 15.01 курс TopJava2 и все пакеты по минимальной цене!** 
...
-  Перевести приложение на Spring Boot (а шаблоны с JSP на <a href="http://www.thymeleaf.org/doc/articles/petclinic.html">Thymeleaf</a>)
-  Сделать авторизацию REST по <a href="https://en.wikipedia.org/wiki/JSON_Web_Token">JWT</a> (см. открытый урок [CloudJava](https://javaops.ru/view/cloudjava))
